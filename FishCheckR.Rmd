...
# Create select input for water body
selectInput(
...
# Apply water body filter if not "all"
if (input$water_body_select != "all") {
filtered_data <- filtered_data |>
filter(water_body == input$water_body_select)
}
...
# Add facet wrap only if "All Water Bodies" is selected
if (input$water_body_select == "all") {
p10 <- p10 + facet_wrap(~water_body)
}
